...
class _HotNewsScreenState extends State<HotNewsScreen> {
  ...
  Future<void> _fetchCategoryAPI() async {
    _isLoading = true;
    setState(() {});
    final NetworkResponse response = await NetworkCaller().getRequest('https://news.fcsapi.com/api/news?access_key=sCXf3aHDy3rdyiHpQ7GRCH');
